...
export default function Archive() {
  return (
    <main className="min-h-screen bg-emerald-50 py-20 px-4 sm:px-6 lg:px-8">
      <motion.div
      ...
      >
        <div className="mb-12">
          <Link
            href="/"
            className="inline-flex items-center text-emerald-800 hover:text-emerald-600 transition-colors"
          >
            <svg
        ...
        <h1 className="text-4xl font-bold text-emerald-900 mb-8">All Projects</h1>
          ...
          <table className="min-w-full divide-y divide-emerald-200">
            <thead className="bg-emerald-50">
              <tr>
                ...
                <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-emerald-800 uppercase tracking-wider hidden md:table-cell">
                  Built with
                </th>
                <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-emerald-800 uppercase tracking-wider">
                  Links
              ...
              {projects.map((project, index) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm font-medium text-emerald-900">{project.title}</div>
                  </td>
